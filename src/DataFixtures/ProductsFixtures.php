...
class ProductsFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $this->createProduct('Air Force 1', 'sneakers blanches en cuir véritable, coupe courte et une semmelle extérieure en caoutchouc pour plus de durabilité' , '135.00' , '3', '2');
